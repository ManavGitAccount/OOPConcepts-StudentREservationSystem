...
public class SRS {
    ...
    // We an effectively create "global" data by declaring collections of objects
    // as public static attributes in the main class. These can be access throughout the
    ...
    // The next collection -- of Section object references -- is encapsulated within a special-purpose
    // class by virtue of how we modeled the SRS in UML; note that we could have encapsulated the
    // preceding three collections in similar fashion, and will in fact do so in Chapter 15.
    /**
     * The SRS schedule of classes class servers as a collection point for Section objects.
     */
    ...
    public static void main(String[] args) {
        ...
        // Create various objects by calling the appropriate constructors.
        // (We'd normally be reading such data from a database file ....)
        ...
        p2 = new Professor("Claudio Cloffi", "560-89-3345",
                "Full Professor", "Computational Social Science");

        p3 = new Professor("Snidey Whiplash", "987-04-8971",
                "Full Professor", "Physical Education");

        // Add these to appropriate ArrayList
        ...
        s2 = new Student("Fred Schnurd", "321-456-9087", "Information Technology", "Ph.D");
        s3 = new Student("Mary Smith", "333-44-1111", "Physics", "B.S");
        ...
        c1 = new Course("CMP101", "Begining Computer Technology", 3.0);
        c2 = new Course("OBJ101", "Object Methods for Software Developement", 3.0);
        ...
        // Adding these to the appropriate ArrayList
        ...
        // Schedule sections of each Course by calling the scheduleSection method
        // of Course (which internally invokes the Section constructor)

        sec1 = c1.scheduleSection('M', "8:10 - 10.00 PM", "GOVT101", 30);
        sec2 = c1.scheduleSection('W', "6:10 - 8:00 PM", "GOVT202", 30);
        sec3 = c2.scheduleSection('R', "4:10 - 6:00 PM", "GOVT303", 25);
        ...
        sec7 = c5.scheduleSection('M', "4:10 - 6:00 PM", "ART525", 40);
        ...
        // Simulate students attempting to enroll in sections of various courses.
        ...
        // These requests should be fine
        attemptToEnroll(s2, sec7);
        attemptToEnroll(s3, sec1);

        // When the dust settles, here's what the folks wound up
        ...
        // Let's see if everything got set up properly by calling various display() methods.
        System.out.println("===================================");
